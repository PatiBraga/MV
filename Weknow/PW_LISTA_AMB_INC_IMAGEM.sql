  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "DBAMV"."PW_LISTA_AMB_INC_IMAGEM" ("Origem", "PAR_CD_ATENDIMENTO", "PAR_CD_PACIENTE", "PAR_NM_PACIENTE", "PAR_NM_FILTRO", "PAR_IDADE_PACIENTE", "Hora do Pedido", "Pedido", "Urgente", "Convênio", "Setor Solicitante", "Exame", "Status", "Guia") AS 
  select
...
order by x.URGENTE desc, x.HR_PEDIDO asc;
   ...
   COMMENT ON TABLE "DBAMV"."PW_LISTA_AMB_INC_IMAGEM"  IS 'EXA - Lista de pacientes Matriz';
