...
b.vl_glosa,
b.vl_acrescimo
from v_ajustes_recebimento a, v_ajustes_recebimento_det b, ITFAT_NOTA_FISCAL c, itreg_fat d, pro_fat e, gru_fat f, tuss g, convenio h
where a.CD_RECCON_REC = b.CD_RECCON_REC
and a.cd_convenio = h.cd_convenio
and c.cd_reg_fat = d.cd_reg_fat 
and b.cd_pro_fat = g.cd_pro_fat
...
b.vl_glosa,
b.vl_acrescimo
from v_ajustes_recebimento a, v_ajustes_recebimento_det b, ITFAT_NOTA_FISCAL c, itreg_amb d, pro_fat e, gru_fat f, tuss g, convenio h
where a.CD_RECCON_REC = b.CD_RECCON_REC
and a.cd_convenio = h.cd_convenio
