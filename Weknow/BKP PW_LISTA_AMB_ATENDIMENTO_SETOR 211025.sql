...
from    (select 
       ...
       decode(c.tp_atendimento,'I','Internação','A','Ambulatório','E','Externo','U','Pronto Atendimento') PAR_NM_FILTRO,
        ...
        and g.cd_set_exa in (38,39,40,41,42,37,41) -- setores do inc imagem barigui
...
order by x.URGENTE desc, x.HR_PEDIDO asc;
   ...
   COMMENT ON TABLE "DBAMV"."PW_LISTA_AMB_ATENDIMENTO_SETOR"  IS 'EXA - Lista de pacientes Barigui Novo';
