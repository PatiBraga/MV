SELECT
  ...
  WHERE 1 = 1
   AND PR.dt_pedido BETWEEN
       TO_DATE('01/03/2026 00:00:00', 'DD/MM/YYYY HH24:MI:SS') AND
       TO_DATE('12/03/2026 23:59:59', 'DD/MM/YYYY HH24:MI:SS')
--   AND IT.cd_laudo IS NOT NULL
  -- AND IT.dt_realizado IS NOT NULL
...
AND dh_criacao_log BETWEEN TO_DATE('01/02/2026 00:00:00', 'DD/MM/YYYY HH24:MI:SS')
AND TO_DATE('28/02/2026 00:00:00', 'DD/MM/YYYY HH24:MI:SS')
AND DBMS_LOB.INSTR(lo_mensagem, utl_raw.cast_to_raw('<codigoItemPedido>255309'), 1, 1) > 0
ORDER BY dh_criacao_log DESC;


dbamv.laudo_rx campo sn_assinado = 'S'