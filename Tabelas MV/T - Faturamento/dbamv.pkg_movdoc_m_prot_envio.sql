...
--Cursor c_conta_fat Is
        ...
        Where a.cd_protocolo_doc = b.cd_protocolo_doc
          ...
          And a.cd_protocolo_doc = ( select max(i.cd_protocolo_doc)
                                     ...
                                     Where i.cd_documento_prot = 20
                                      and  i.cd_reg_fat = 102712 )
/
SELECT  * FROM dbamv.PROTOCOLO_DOC WHERE cd_protocolo_doc IN (94041)
/
SELECT  * FROM dbamv.it_PROTOCOLO_DOC WHERE cd_protocolo_doc IN (94041)
/
SELECT cd_remessa FROM dbamv.reg_fat WHERE cd_reg_fat = 102712
/
SELECT * FROM dbamv.documento_prot WHERE cd_documento_prot = 20
