select c.cd_paciente, c.nm_paciente, trunc(c.dt_nascimento)dt_nascimento, a.cd_atendimento, to_char(b.dt_gravacao,'dd/mm/yyyy hh24:mi')dt_gravacao, to_char(b.hr_agenda,'dd/mm/yyyy hh24:mi')hr_agenda, trunc(b.hr_agenda-b.dt_gravacao)dias_agenda, to_char(a.hr_atendimento,'dd/mm/yyyy hh24:mi')hr_atendimento,
